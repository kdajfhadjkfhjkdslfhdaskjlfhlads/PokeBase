...
const resolveFunctionsFromConfig = async (cwd, branchName) => {
	...
	return {
		...
		functions: (resolveConfig(config, {
			...
			const source = isAbsolute(fn.source) ? fn.source : resolve(configDir, fn.source);
			...
			return {
				...
				name: fn.name,
				source,
				...devPort(fn.dev) !== void 0 ? { port: devPort(fn.dev) } : {},
				env: { ...fn.env },
...
//#endregion
export { resolveFunctionsFromConfig };
